...
`docs/architecture.md` — Routing et rendu · Couche données · Espace cours · Éditeurs · Assistant IA · Markdown de cours · Impression · Pages élèves et tuteur · Recherche · Réglages IA · Mesure d'audience et consentement · Design system et styles.
